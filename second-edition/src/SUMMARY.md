...
- [Um projeto de E/S: Criando um Programa de Linha de Comando](ch12-00-an-io-project.md)
    ...
    - [Lendo Arquivo](ch12-02-reading-a-file.md)
...
- [Recursos Funcionais da Linguagem: Iteradores e Closures](ch13-00-functional-features.md)
    - [Closures: Funções Anônimas que Podem Capturar seu Ambiente](ch13-01-closures.md)
    - [Processando uma Série de Itens com Interadores](ch13-02-iterators.md)
    - [Melhorando Nosso Projeto de E/S (I/O)](ch13-03-improving-our-io-project.md)
    - [Comparando o Desempenho: Loops x Iteradores](ch13-04-performance.md)
...
- [Concorrência sem Medo](ch16-00-concurrency.md)
    ...
    - [Passando Mensagens](ch16-02-message-passing.md)
